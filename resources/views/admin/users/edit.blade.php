                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="Name" value="{{ $user->name??old('name') }}" required>
                                        @error('name')
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="mobile" class="form-control" placeholder="Mobile" value="{{ $user->mobile??old('mobile') }}">
                                        @error('mobile')
                                        <div class="text-danger small mt-1">
                                           {{ $message }}
                                        </div>
