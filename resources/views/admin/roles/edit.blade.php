                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="Name" value="{{ $role->name??old('name') }}" required>
                                        @error('name')
                                            ...
                                            <div class="col-md-3 mb-2">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" name="permissions[]"
                                                        ...
                                                        {{ in_array(is_object($permission) ? $permission->name : $permission, $rolePermissions) ? 'checked' : '' }}>
